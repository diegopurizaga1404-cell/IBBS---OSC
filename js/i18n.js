...
const I18n = (() => {
    const _translations = {
        es: {
            ...
            "T1_BTN_SOLO_ENTIDADES": "IBBS Issues",
            ...
            "T6_COL_REG_DATE": "Fecha de registro",
            "T6_COL_INCIDENT_TIME": "Tiempo de inicio",
            "T6_COL_LLAMADA_ENTIDAD": "Contacto",
            "T6_COL_VISITA_PREVISTA": "Visita",
            "T6_COL_TEAM_REG": "Registra",
            "T6_COL_REG_TYPE": "Tipo de Registro",
            "T6_REG_TYPE_USER": "Customer Complaint",
            "T6_COL_TEAM_RES": "Team Responsable",
            "T6_COL_CLOSE_TIME": "Fecha de Cierre",
            ...
            "T6_HM_REGISTRO": "Registro",
            "T6_HM_NOMBRE": "Nombre Completo",
            "T6_HM_DNI": "DNI",
            "T6_HM_CELULAR": "Celular",
            "T6_HM_EMAIL": "Correo Electrónico",
            "T6_HM_TIEMPO_INICIO": "Tiempo de Inicio",
            "T6_HM_REGION": "Región",
            "T6_HM_PROVINCIA": "Provincia",
            "T6_HM_LOCALIDAD": "Localidad",
            "T6_HM_TIPO": "Tipo",
            "T6_HM_DESC_REPORTADA": "Descripción Reportada",
            "T6_HM_CLASIF_SEGUIMIENTO": "Clasificación y Seguimiento",
            "T6_HM_ESTADO": "Estado",
            "T6_HM_CLASIFICACION": "Clasificación",
            "T6_HM_TEAM_RES": "Team Resolutor",
            "T6_HM_CERRADO_POR": "Cerrado por",
            "T6_HM_HORA_CIERRE": "Hora de Cierre",
            "T6_HM_DURACION": "Duración",
            "T6_HM_HORA_CONTACTO": "Hora de contacto a la entidad",
            "T6_HM_DIA_VISITA": "Día de visita técnica previsto",
            "T6_HM_NOTAS_TEC": "Notas Técnicas",
            ...
            "ADMIN_ROLE_TECNICO": "Técnico O&M",
        ...
        en: {
            ...
            "T6_COL_REG_DATE": "Registration Date",
            "T6_COL_INCIDENT_TIME": "Incident Time",
            "T6_COL_LLAMADA_ENTIDAD": "Contact",
            "T6_COL_VISITA_PREVISTA": "Visit",
            "T6_COL_TEAM_REG": "Registers",
            "T6_COL_REG_TYPE": "Registration Type",
            "T6_REG_TYPE_USER": "Customer Complaint",
            "T6_COL_TEAM_RES": "Responsible Team",
            "T6_COL_CLOSE_TIME": "Close Date",
            ...
            "T6_HM_REGISTRO": "Record",
            "T6_HM_NOMBRE": "Full Name",
            "T6_HM_DNI": "ID Number",
            "T6_HM_CELULAR": "Phone",
            "T6_HM_EMAIL": "Email",
            "T6_HM_TIEMPO_INICIO": "Start Time",
            "T6_HM_REGION": "Region",
            "T6_HM_PROVINCIA": "Province",
            "T6_HM_LOCALIDAD": "Locality",
            "T6_HM_TIPO": "Type",
            "T6_HM_DESC_REPORTADA": "Reported Description",
            "T6_HM_CLASIF_SEGUIMIENTO": "Classification & Tracking",
            "T6_HM_ESTADO": "Status",
            "T6_HM_CLASIFICACION": "Classification",
            "T6_HM_TEAM_RES": "Resolution Team",
            "T6_HM_CERRADO_POR": "Closed by",
            "T6_HM_HORA_CIERRE": "Closing Time",
            "T6_HM_DURACION": "Duration",
            "T6_HM_HORA_CONTACTO": "Entity contact time",
            "T6_HM_DIA_VISITA": "Planned technical visit",
            "T6_HM_NOTAS_TEC": "Technical Notes",
            ...
            "ADMIN_ROLE_TECNICO": "O&M Technician",
